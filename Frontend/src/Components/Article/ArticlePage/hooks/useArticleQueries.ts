...
export const useArticleQueries = (setIsLiked: (isLiked: boolean) => void, isLiked: boolean, article: IArticle|undefined) => {
  ...
  return {likeMutation, commentsData, isCommentsLoading}
}